...
export declare type Submitter = HTMLInputElement | HTMLButtonElement | null | undefined;
...
export declare type SelectorType = string | SelectorInterface;
...
export declare type FetchRequestBody = Blob | BufferSource | FormData | URLSearchParams | ReadableStream | undefined;
...
export interface Adapter {
    visit: (location: Locateable, { action }: {
        action: VisitAction;
    }) => void;
    clearCache: () => void;
    supported?: boolean;
...
export declare type VisitAction = 'advance' | 'replace' | 'restore';
...
export declare type ErrorRenderer = "turbo" | "morphdom";
